...
| 21 | 2026-09 | **MOMENTUM VERFEINERT** (dem #20-Fund nachgehen): 6 dokumentierte Veredelungen von 12-1 — vol-skaliertes Ranking, residuales/idiosynkratisches Momentum (Blitz-Huij-Martens), vol-managed (Barroso-Santa-Clara), Regime-Filter (>200T), Long-only — je monatlich, 5 bps, volle Rigor-Batterie | _(läuft auf VM — Ergebnis in `experiment21_results.md`)_ | ⏳ |
