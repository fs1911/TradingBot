...
| 23 | 2026-09 | **REBALANCING-PRÄMIE** (Volatilitäts-Ernte, Fernholz): der einzige verbleibende *strukturelle* (nicht-prognostische) Mechanismus. Überschuss (periodisch auf Gleichgewicht zurückgesetzt − einfach halten) auf demselben Universum, wöchentlich/monatlich/quartalsweise über Kosten, volle Rigor-Batterie. Beta & Survivor-Bias heben sich zwischen beiden Beinen auf | _(läuft auf VM — Ergebnis in `experiment23_results.md`)_ | ⏳ |
