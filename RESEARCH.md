...
| 26 | 2026-09 | **CARRY BREITER/SMARTER**: kann der eine echte Edge vergrößert/robuster werden? 3 Varianten über ~24 Perps — breiter Gleichgewichts-Korb, carry-gewichteter Tilt (kausal aus Trailing-Funding), Cross-Sectional-Dispersions-Spread (hoch- vs. niedrig-Funding) — je durch die volle Batterie | _(läuft auf VM — Ergebnis in `experiment26_results.md`)_ | ⏳ |
