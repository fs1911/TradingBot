...
| 30 | 2026-09 | **BEWERTUNGS-GAUGES für Finanzradar** (Drawdown vom ATH & Abstand 200T-MA) über native Broker-Preise (kein ccxt): sagt „billig" (tiefer Drawdown / weit unter MA) höhere Folge-Renditen (90T) voraus? Indizes + Krypto, pro Asset Contrarian-Test + gepoolte Kaufen/Halten/Überhitzt-Bänder | _(läuft auf VM — Ergebnis in `experiment30_results.md`)_ | ⏳ |
