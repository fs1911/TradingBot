...
| 27 | 2026-09 | **CROSS-EXCHANGE-FUNDING-DIFFERENZ** (low-turnover Carry): umgeht #25s Turnover-Killer? Dieselbe Perp long auf Niedrig-Funding-Börse, short auf Hoch-Funding-Börse = perp-neutral, kein Spot, erntet die Börsen-Differenz. Über mehrere Coins, volle Batterie | _(läuft auf VM — Ergebnis in `experiment27_results.md`)_ | ⏳ |
