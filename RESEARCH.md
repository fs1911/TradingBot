...
| 35 | 2026-09 | **ARTEFAKT-TEST des Trendfilters**: #34s Vorteil (8,8 % vs 6,65 % real) basiert auf Shiller-Monatsdurchschnitten, die künstliche Trends erzeugen. Identische Regeln, einmal mit Durchschnitten, einmal mit echten Monatsend-Schlusskursen (S&P täglich seit 1927); Autokorrelation direkt gemessen; 0-%-Cash-Variante; Aufteilung 1928–49 / 1950–89 / 1990– | _(läuft auf VM — Ergebnis in `experiment35_results.md`)_ | ⏳ |
